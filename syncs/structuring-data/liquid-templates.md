...
One special use for Liquid templates is to build JSON documents. This can be great for advanced API usage with [templated fields](/broken/pages/-MV8ovxVCiy1fEjc0SO-#using-templates-to-tranform-source-data) or even building custom integrations with the [HTTP Request](../../destinations/http-request.md) destination.
