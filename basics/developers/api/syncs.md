...
| filter\_segment\_id                               | <p>The id of the filter segment IF we are creating a sync for a segment. <br><br>Note: you must submit this property along with the param:<br> <code>{source: {type: "model", id: [the id of the related model]}</code></p>                                                                                                                             |
...
| failed\_record\_notifications\_threshold\_percent | The percentage of rejected and invalid records for which failed record emails will be triggered. Default is `75`.                                                                                                                                                                                                                                       |
