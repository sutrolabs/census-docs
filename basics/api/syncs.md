...
| mirror\_strategy                 | <p>Used when <code>operation</code> is <code>mirror</code>. Specifies what Census should do when records no longer appear in the source.</p><p></p><p>Values are populated by default when mirror syncs are created, but can be overriden with manual values.  Valid strategies are:</p><ul><li><code>upload_and_swap</code></li><li><code>sync_updates_and_deletes</code></li><li><code>sync_updates_and_nulls</code></li></ul> |
