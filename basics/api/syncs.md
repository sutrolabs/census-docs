...
| mirror\_strategy                 | <p>Used when <code>operation</code> is <code>mirror</code>. Specifies how changes to the source should update existing records. </p><p></p><p>Values are populated by default when mirror syncs are created, but can be overriden with manual values.  Valid strategies are:</p><ul><li><code>upload_and_swap</code></li><li><code>sync_updates_and_deletes</code></li><li><code>sync_updates_and_nulls</code></li></ul> |
