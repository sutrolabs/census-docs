...
| source\_object\_id      | Unique identifier for the specific data source in the source connection that this sync is sending data from. This could be a table, model, entity, or segment.                                    |
