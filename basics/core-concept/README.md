...
| Mirror                           | <p>Keep the destination in sync with the source.</p><ul><li>If a row is added or edited in the source, update the destination. </li><li>If a row is removed from the source, remove the matching object from the destination. Note: some services such as Braze offer other actions as well. See specific connector documentation for more details.</li></ul> |
...
| Append Only by timestamp         | Some Event-data syncs can be very high volume. In these cases, it may be more efficient                                                                                                                                                                                                                                                                       |
