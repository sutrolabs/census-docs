...
As of Early 2022, the following services are not yet supported: Facebook Audiences, Google Ads, Google Cloud Storage, Google Sheets, Iterable, Mailchimp, Microsoft Ads, NetSuite, and Outreach.
