...
Contact the support team if you want Census to support more Amplitude objects and/or behaviors.
...
‌ 🔋 Contact the support team if you want Census to support more Sync Behaviors for this destination.
