...
* Credentials for your data warehouse: For details, see the guide for your [specific data source technology](s3.md#step-2-connect-your-data-warehouse).
...
5. Enter authentication details for your AWS account and S3 bucket: **Access Key ID**, **Secret Key**, **Bucket Name**, and **AWS Region**. Census uses these details to authenticate – they must match your AWS setup. If you would like to use role based access instead, see the instructions below.
...
Step 1: When configuring the S3 destination click the "Use role instead" checkbox. Provide your bucket and region, but leave access and secret key blank. Click next:
...
* Finish setting up your Role. Note that it should have the [required permissions](s3.md#required-permissions) to access the bucket assigned to it!
