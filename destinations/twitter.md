...
Rate limits affect how many records you can sync in a specific period of itme. X Ads API has a rate limit of 1,500 calls per minute. Calls to sync audience data and conversion event data share the same rate limit.
...
| Conversion Event |        ✅       | App ID, Conversion Time, Conversion Type, Hashed Device ID, OS Type |
