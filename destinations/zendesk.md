...
| --------------------: | :------------: | ------------------------------------ | ------------------------------------- |
|              End User |        ✅       | External ID (recommended), Email, ID | Update or Create, Update Only, Delete |
|          Organization |        ✅       | External ID (recommended), Name, ID  | Update or Create, Update Only, Delete |
|                Ticket |        ✅       | External ID, ID                      | Update or Create, Update Only, Delete |
