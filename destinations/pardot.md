...
Contact the support team if you want Census to support more objects for Pardot.
...
Contact the support team if you want Census to support more Sync Behaviors for Pardot.
