...
{% hint style="info" %}
We also support the ability to use your own object storage provider for an extra layer of security and privacy. [Read more here 👉](../data-storage/customer-provided-object-storage.md)
{% endhint %}
