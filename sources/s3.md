...
1. You give Census the name of an S3 bucket you control and a [prefix](https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-prefixes.html) within that bucket to scan for objects.
...
5. Census will scan your S3 bucket and retrieve the headers of your CSV, and use that to guide you through the rest of the sync configuration process.
